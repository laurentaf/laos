...
| Path | Purpose |
|------|---------|
| `spec/constitution.md` | 9 articles governing README quality |
| `spec/todo.md` | Task tracker with 5 stages |
| `spec/specs/000-bootstrap/spec.md` | Main spec with criteria |
| `spec/design-direction.md` | Visual direction principles |
| `contract.md` | Project contract (brief, needs, deliverables) |
| `../readme-audit-2026-06-19.md` | Full audit report with rankings |

...
| Status atual | BASIC (M0 completo) |
...
| Binding conditions | `projects/_meta/capability-architect/binding-conditions.md` (R1-R5 + G1-G9, 14 condições) |
...
- **Aplicação do scaffold template padronizado** (G1–G9 abaixo) — toda capability nova nasce BASIC, 30d para STABLE.
...
## Condições vinculantes (14 itens consolidados)
...
### Section B — Quality gates por capability nova (9 vinculantes, G1–G9)
...
| **G9** | **Commit+push obrigatório pós-sign-off** para mudanças estruturais aprovadas (LACOUNCIL 391a8179). | LACOUNCIL 391a8179 (maioria, 4/4 SIM) |

**Total:** 5 + 9 = **14 condições vinculantes**. Detalhamento em `binding-conditions.md`.
...
| **M0-3** | `binding-conditions.md` com R1-R5 + G1-G9 + mapeamento de 4 emendas | ✅ entregue |
...
|---------|----------------------|--------|------|
| capability-architect (este) | 2026-06-04 | M0 completo | Scaffold do meta-agente + 14 condicoes vinculantes |
...
- **14 condições vinculantes** (R1-R5 + G1-G9) substituem as 17 ad-hoc da LAECON. A próxima capability nova vai herdar o template, não inventar novas condições.
...
- **G9 (commit+push obrigatório)** foi adicionado via LACOUNCIL 391a8179 para fechar o gap de mudanças estruturais que ficavam apenas locais.

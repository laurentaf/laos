...
def build_plan(data: dict[str, Any], analysis: dict[str, Any] | None = None) -> list[dict[str, Any]]:
    ...
    system = (
        ...
        "ordenadas (3 a 6 fases) para o MVP ITERÁVEL — nunca o sistema "
        "inteiro. REGRAS:\n"
        "  - Se o brief for GRANDE ('um sistema tipo YouTube', 'uma "
        "  plataforma completa'), planeje SÓ o MVP: as 4-6 fases que "
    ...
    prompt = (
        ...
        "Proponha as fases do MVP. Cada fase: stage numerado (1..N), "
        "name, spec detalhada em português FUNDAMENTADA na análise "
        "(mencione a entidade/regra/risco que resolve), artifacts com "
        "path sob artifacts/<subdir>/. Se o escopo for muito grande, "
        "planeje o MVP de 4-6 fases e deixe o resto para iterações "
        "futuras."
    )
